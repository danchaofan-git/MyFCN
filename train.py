...
def create_model(aux, num_classes, pretrain=False):
    ...
    if pretrain:
        if not os.path.exists('./fcn_resnet50_coco-1167a1af.pth'):
            from torch.hub import load_state_dict_from_url
            load_state_dict_from_url('https://download.pytorch.org/models/fcn_resnet50_coco-1167a1af.pth', './')
...
def parse_args():
    ...
    parser.add_argument("--data-path", default = r"F:\dataset\cityscapes\Cityspaces", help="VOCdevkit root")
    ...
    parser.add_argument("--save_freq", default=10, type=int, help="save weights frequency")
